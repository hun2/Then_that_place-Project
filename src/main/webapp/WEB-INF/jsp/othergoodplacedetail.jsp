...
<body>
	...
	<div class="bodycontent2">
		<div class="bodycontent2wrapper">
			...
			<input type="hidden" class="hiddenid" value="${placeList.id}">
			<div class="title">제목</div>
			<input type="text" class="bodycontent2input" value="${placeList.placeSubject}" readonly >
			<div class="title">내용</div>
			<textarea rows="5" cols="68" class="placeContent" readonly>${placeList.placeContent}</textarea>
			...
			<a class="submit1" href="/main/othergoodplace" style="background-color: #333; border-color: #333; color: #fff;" id="submit">목록</a>
		</div>
	</div>
	<!-- 중간 글쓰기 영역 끝 -->
</body>
