			...
			<div id="bodycontainer">
				<c:forEach items="${badPlaceList}" var="badPlace">
					<div class="item">
						...
						<a href="/main/places/bad-detail?placeId=${badPlace.place.id}"><img src="${empty badPlace.placeImage[0].imagePath ? '/static/img/no.png' : badPlace.placeImage[0].imagePath }" class="bodyimg"> </a>
					</div>
				</c:forEach>
			</div>
		</div>
