...
<body>
	...
	<div class="member">
		...
		<div class="field">
			<b>아이디</b> 
			<span class="placehold-text"> <input  type="text" id="userId"> </span> 
			<small id="limitText" class="showLimit d-none">4~12자의 영문 소문자, 숫자와 특수기호(_),(-)만 사용 가능합니다.</small> 
			<small id="isDuplicationText" class="showTrue d-none">이미 사용중인 아이디입니다. </small> 
		...
		<!-- 가입하기 버튼 -->
		<input type="hidden" value="${userEmail}" class="userEmail">
		<input type="hidden" value="${userNickName}" class="userNickName">
		<input type="hidden" value="${kakaoId}" class="kakaoId">
