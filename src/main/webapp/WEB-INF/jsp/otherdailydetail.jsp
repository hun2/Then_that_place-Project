...
<body>
	...
	<div class="bodycontent2">
		<div class="bodycontent2wrapper">
			...
			<input type="text" class="bodycontent2input" value="${dailyList.dailySubject}" readonly >
			<div class="title">내용</div>
			<textarea rows="5" cols="68" class="placeContent" readonly>${dailyList.dailyContent}</textarea>
			...
			<a class="submit1" href="/main/otherdaily" style="background-color: #333; border-color: #333; color: #fff;" id="submit">목록</a>
		</div>
	</div>
	<!-- 중간 글쓰기 영역 끝 -->
</body>
