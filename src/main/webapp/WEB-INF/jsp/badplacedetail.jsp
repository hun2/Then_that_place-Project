...
<body>
	 ...
	 <div id="top_wrap">
		...
		<nav id="wrap_topCate" class=""
			...
			<ul class="inner">
				...
				<li><a href="/main/places/bad"> <span class="on black">죽어서도
	...
	<div class="bodycontent2">
		<div class="bodycontent2wrapper">
			...
			<a class="submit4" href="/main/places/bad" style="background-color: #333; border-color: #333; color: #fff;" id="submit">메인페이지</a>
		</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.submit2').on('click', function(){
				...
				//평점 변수
				var placeGrade = $("input:checkbox[name='rating']:checked").length;
				//카테고리 변수
